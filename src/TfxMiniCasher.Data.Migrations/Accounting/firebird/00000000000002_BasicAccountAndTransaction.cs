        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaRowVersion = table.Column<byte[]>(rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accounting_Accounts", x => x.Id);
                    table.UniqueConstraint("AK_Accounting_Accounts_Account~", x => x.AccountId);
                    table.ForeignKey(
                        name: "FK_Accounting_Accounts_Account~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounting_Transactions_Acc~",
                        column: x => x.CreditAccountId,
                        principalTable: "Accounting_Accounts",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Accounting_Transactions_Ac~1",
